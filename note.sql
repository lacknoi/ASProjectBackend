...
select a.*,rowid from USRDEBT.AS_PM_ACCOUNT_BALANCE a;
select a.*,rowid from USRDEBT.AS_PM_INVOICE_BALANCE a;
select a.*,rowid from USRDEBT.AS_PM_AR_TRANSACTION a;

select a.*,rowid from USRDEBT.AS_AC_MOBILES a;
